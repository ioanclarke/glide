...
class Game(arc.View):
	...
	# 	self.eng.initialize_game()

	def setup_engine(self, gamescr):
		#elf.eng = eng
		self.eng = engine.Engine()  ########FIX THIS
		self.eng.create_player()
		self.eng.assign_gamescr(gamescr)
	...
	def setup(self):
		...
		# print(repr(self.eng.player_sprite))
		# print(repr(self.eng.wall_list))
